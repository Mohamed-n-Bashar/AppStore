  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: ListTile(
              ...
              title: const Text(appName, style: TextStyle( color: Colors.black, fontSize: 30 , fontWeight: FontWeight.w900),),
              subtitle: const Row(
                children: [
                  Icon(Icons.cloud_download_outlined, color: Colors.black),
                  SizedBox(width: 5),
                  Text(appSize, style: TextStyle( color: Colors.black, fontSize: 15 , fontWeight: FontWeight.w900),),
                ],
              ),
            ),
          ),
            ...
            child: Column(
              ...
              child: const Row(
                ...
                TextButton(
                  ...
                  onPressed: () {
                    IOS_appURL == null ? _showMessage(context) : _IOS_downloadApk() ;
                  },
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
        ...
        const Text("What is $appName?", style: TextStyle( color: Colors.black, fontSize: 25 , fontWeight: FontWeight.w900, fontFamily: "web"), textAlign: TextAlign.center,),
        const Padding(
          padding: EdgeInsets.symmetric(horizontal: 10),
          child: Text(appDescription,style: TextStyle( color: Colors.black, fontSize: 15 , fontWeight: FontWeight.w900), textAlign: TextAlign.center,),
        ),
        const SizedBox(height: 40),
        const Text("$appName’s Top Features", style: TextStyle( color: Colors.black, fontSize: 25 , fontWeight: FontWeight.w900, fontFamily: "web"), textAlign: TextAlign.center,),
        Padding(
